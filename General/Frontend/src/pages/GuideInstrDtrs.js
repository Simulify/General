    ...
    return (
        ...
        <tbody>
          <tr>
            <td>010100</td>
            <td >MOV REG OP</td>
            <td >Transférer le contenu de l'opérande OP vers<br/> le registre.</td>
          ...
          <tr>
            <td>010101</td>
            <td >CHM OP</td>
            <td >Le contenu de l'accumulateur est écrasé <br/>par le contenu de l'opérande OP.</td>
          ...
          <tr>
            <td>010110</td>
            <td >RGM ADR</td>
            <td >Le contenu de l'accumulateur est rangé<br/> dans l'adresse ADR.
            </td>
          ...
          <tr>
            <td>010111</td>
            <td >PUSH REG</td>
            <td >Empiler le contenu du registre au sommet<br/> de la pile.</td>
          ...
          <tr>
            <td>011000</td>
            <td >POP REG</td>
            <td >Dépiler le mot présent au sommet de la<br/> pile et le mettre dans le registre.</td>
            <td className='t'>Registre</td>
            <td className='t'>R = REG</td>
          </tr>
        </tbody>

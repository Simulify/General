...
function Table() {
  ...
  <td >000101</td>
  <td >NOT OP</td>
  <td >Le NON logique du contenu de l'opérande OP.<br/><br/>
...
<tr>
  <td > 000110</td>
  <td >AND REG OP</td>
  <td rowSpan="5" className='lft'>Le ET/OU, NON ET/OU, OU exclusif logique entre<br/> le contenu de l'opérande OP et le contenu de <br/>registre.
...
<tr><td >001011</td>
  <td >CMP REG OP</td>
  <td >La comparaison logique entre le contenu de <br/> l'opérande OP et le contenu de registre, pour <br/>positionner le registre flags.</td>
  <td className='t'>Tous</td>
  <td className='t'>R = REG <br/> (MOD = 011)</td>
</tr>
  <tr><td >001100</td>

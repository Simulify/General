    ...
    return (
        ...
        <tbody>
          <tr>
            <td>001101</td>
            <td >SHL OP N</td>
            <td rowSpan="2">Décaler les bits du contenu de l'opérande OP,<br/>
             N fois vers la gauche/droite et remplacer les bits <br/>décalés par des 0.</td>
          ...
          <tr>
            <td>001111</td>
            <td >ROL OP N</td>
            <td rowSpan="2">Une rotation des bits du contenu de l'opérande OP,<br/> N fois vers la gauche/droite.</td>
            <td rowSpan="2" className='t'>Tous sauf <br/>Immédiat</td>
            <td rowSpan="2" className='t'>R = REG <br/> (MOD = 011) <br/>C = N</td>
          </tr>
          <tr>

    ...
    return (
        ...
        <tbody>
          <tr>
            <td>010001</td>
            <td >LOOP ETIQ</td>
            <td >(Boucle Pour), Décrémenter CX après chaque<br/> itération, et vérifier son contenu.
            <br/>Si CX ≠ 0 : reboucler (brancher vers l'adresse de <br/> l'étiquette ETIQ).
            <br/>Sinon (CX = 0) : passer à l'instruction suivante.
            </td>
          ...
          <tr>
            <td>010010</td>
            <td >BCV CDT ETIQ</td>
            <td rowSpan="2">Vérifier la condition CDT dans le registre flags,<br/> et brancher vers l'adresse de l'étiquette ETIQ, si :
            <br/><br/>BCV : CDT est vérifiée.
            <br/>BCF : CDT n'est pas vérifiée.
            <br/><br/>CDT = 0 : branchement inconditionnelle.
            </td>
